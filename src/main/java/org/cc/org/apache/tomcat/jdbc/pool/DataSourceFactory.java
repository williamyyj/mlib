...
public class DataSourceFactory implements ObjectFactory {
    ...
    public Object getObjectInstance(Object obj, Name name, Context nameCtx,
        ...
        if (org.cc.org.apache.tomcat.jdbc.pool.DataSource.class.getName().equals(ref.getClassName())) {
            ok = true;
        }
    ...
    public DataSource createDataSource(Properties properties,Context context, boolean XA) throws Exception {
        ...
        org.cc.org.apache.tomcat.jdbc.pool.DataSource dataSource = XA?
                new org.cc.org.apache.tomcat.jdbc.pool.XADataSource(poolProperties) :
                new org.cc.org.apache.tomcat.jdbc.pool.DataSource(poolProperties);
