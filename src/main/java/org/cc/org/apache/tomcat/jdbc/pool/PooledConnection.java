...
import org.cc.org.apache.tomcat.jdbc.pool.interceptor.ConnectionState;
    ...
    protected void connectUsingDriver() throws SQLException {
        ...
        try {
            ...
            if (parent.jmxPool!=null) {
                parent.jmxPool.notify(org.cc.org.apache.tomcat.jdbc.pool.jmx.ConnectionPool.NOTIFY_CONNECT,
