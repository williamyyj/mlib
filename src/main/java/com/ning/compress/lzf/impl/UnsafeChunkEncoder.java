...
/**
 * {@link ChunkEncoder} implementation that handles actual encoding of
 * individual chunks, using Sun's <code>sun.misc.Unsafe</code> functionality,
 * which gives nice extra boost for speed.
 *
